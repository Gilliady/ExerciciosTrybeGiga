...
describe('a função createItem', () => {
  ...
  it('Lança um erro se o nome do item não é uma string', () => {
    expect(() => createItem(1.99,'kg', 'banana', 10)).toThrow('O nome do item deve ser uma string');
  });
  it('Lança um erro se o preço é negativo', () => {
    expect( () => createItem('banan', 'kg', -0.01)).toThrow('O preço do item deve ser maior que zero');
  });
